...
const producto = productos.find((p) => [p.id](http://p.id/) == id);
...
if (precioEnvio !== null) {
resultadoEnvio.innerHTML =       `<p>Precio de envío a ${cp}: $${precioEnvio}</p>       <p>Total con envío: $${producto.precio + precioEnvio}</p>`    ;
} else {
